...
specificCallHandlers = c(
    ...
    makeCallList(c('dmnorm_chol', 'dmvt_chol', 'dwish_chol', 'dinvwish_chol', 'dcar_normal', 'dcar_proper', 'dmulti', 'dcat', 'dinterval', 'ddirch', 'dnorm_invgamma'), 'dmFunHandler')
         )
...
specificCallHandlers[['rnorm_invgamma']] <- 'rmFunHandler'
