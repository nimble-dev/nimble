...
#' @aliases modelBaseClass getVarNames getNodeNames topologicallySortNodes resetData setData isData isEndNode getDistribution isDiscrete isBinary isStoch isDeterm isTruncated isUnivariate isMultivariate getDimension getDependencies getDependenciesList getDownstream expandNodeNames setInits checkConjugacy getCode getMacroParameters newModel getParents [[,modelBaseClass-method [[<-,modelBaseClass-method initializeInfo
#' @export
#' @description
...
'
                                  ...
                                  getMacroParameters = function(LHS = TRUE, RHS = TRUE, determ = TRUE, 
                                                                stoch = TRUE, indices = FALSE) {
                                      '
