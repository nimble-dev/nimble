...
runMCMC <- function(mcmc,
    ...
    for(i in 1:nchains) {
        ...
        mcmc$run(niter, nburnin = nburnin, thin = thinToUseVec[1], thin2 = thinToUseVec[2], progressBar = progressBar, resetWAIC = FALSE, chain = i) #, samplerExecutionOrder = samplerExecutionOrderToUse)
