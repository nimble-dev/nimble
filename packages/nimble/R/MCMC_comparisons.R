...
#'
#' @param doSamplePlots (default FALSE) This is passed to \code{\link{MCMCsuit}} as both the \code{makePlots} and \code{savePlots} argument.
#'
...
#'
#' @name (default "MCMCresults") name to be given to the resulting set of comparisons.  This will be used in the html generated by \code{\link{make_MCMC_comparison_pages}}.  It is simply a list name and thus can easily be modified later.
#'
