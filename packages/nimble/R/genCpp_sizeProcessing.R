...
sizeCalls <- c(makeCallList(binaryOperators, 'sizeBinaryCwise'),
               ...
               makeCallList(c('calculate', 'calculateDiff', 'getLogProb', 'decide', 'size', 'getsize', 'endNimbleTimer'), 'sizeScalar'),
               makeCallList(c('simulate', 'blank', 'nfMethod', 'nimFunListAccess', 'getPtr', 'startNimbleTimer'), 'sizeUndefined')
               )

scalarOutputTypes <- list(decide = 'logical', size = 'integer', isnan = 'logical', ISNA = 'logical', '!' = 'logical', endNimbleTimer = 'double') # , nimArr_rcat = 'double', nimArr_rinterval = 'double')
