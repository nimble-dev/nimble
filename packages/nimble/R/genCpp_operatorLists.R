...
nimDerivsPrependTypeOperators <- c("dnorm", "dpois", "dgamma", "dinvgamma", "dexp_nimble", "dexp", "dlnorm", "dweibull",
...
## reflects distribution funs that support AD, see nimDerivs_TMB.h
