...
MCMCconf <- setRefClass(
    ...
    methods = list(
        ...
        initialize = function(model, nodes, control = list(), ##rules,
            ...
            enableWAIC = getNimbleOption('MCMCenableWAIC'), waicControl = list(),
...
waicControl A named list of inputs that control the behavior of the WAIC calculation, passed as the \'control\' input to \'buildWAIC\'. See \'help(waic)\`.
...
#' @param waicControl A named list of inputs that control the behavior of the WAIC calculation. See \code{help(waic)}.
...
configureMCMC <- function(model, nodes, control = list(), 
    ...
    thisConf <- MCMCconf(model = model, nodes = nodes, control = control, ##rules = rules,
                         ...
                         enableWAIC = enableWAIC, waicControl = waicControl,
