...
buildMCEM <- nimbleFunction(
  ...
  setup = function(model, paramNodes, latentNodes, calcNodes, calcNodesOther,
    ...
    if(!is.null(config)) {
      ...
      message("  [Note] Configuring MCMC for random effects nodes (warnings about unsampled nodes can be ignored):")
