...
#'
#' @param model A model such as returned by \link{\code{nimbleModel}}.
#'
...
#'
#' @export
#' @details This is used internally by getParam.  It is not intended for direct use by a user or even a nimbleFunction programmer. 
