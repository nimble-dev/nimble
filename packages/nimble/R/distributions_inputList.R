...
distributionsInputList <- list(
    ...
    dmnormAD = list(BUGSdist = 'dmnormAD(mean, prec, cov, prec_ldet, prec_param)',
                   Rdist    = c('dmnorm_prec_ldet(mean, prec_ldet = PDinverse_logdet(cov), prec_param = 0)',
                                'dmnorm_prec_ldet(mean, prec_ldet = PDinverse_logdet(prec), prec_param = 1)',
                                'dmnorm_prec_ldet(mean, prec_ldet, prec_param)'),
                   altParams= c('prec = calc_dmnorm_prec_ldet_AltParams(prec_ldet, prec_param, 1)',
                                'cov = calc_dmnorm_prec_ldet_AltParams(prec_ldet, prec_param, 0)'),
                   types    = c('value = double(1)', 'mean = double(1)', 'prec_ldet = double(1)', 'prec = double(2)', 'cov = double(2)')),
