...
distributionsInputList <- list(
    ...
    dmnormAD = list(BUGSdist = 'dmnormAD(mean, prec, cov, prec_ldet)',
                   Rdist    = c('dmnorm_prec_ldet(mean, prec_ldet = PDinverse_logdet(cov, prec_param = 0))',
                                ...
                                'dmnorm_prec_ldet(mean, prec_ldet)'),
                   altParams= c('prec = calc_dmnorm_prec_ldet_AltParams(prec_ldet, 1)',
                                'cov = calc_dmnorm_prec_ldet_AltParams(prec_ldet, 0)'),
                   mixedSizes = TRUE,
