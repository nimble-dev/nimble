...
try(test_that(paste0("population of member data in full nimbleFunctionInteface"),
...
try(test_that(paste0("getting of member data in full nimbleFunctionInteface"),
...
ans3 <- f3$run()
cans3 <- cf3$run()
try(test_that(paste0("populating member data in multi nimbleFunctionInteface"),
