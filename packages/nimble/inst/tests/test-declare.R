...
test_that("1D declare without sizes, then resize without c()", {
    ...
    nf1 <- nf()
    expect_equivalent(nf1$run(), 1:3, "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(), 1:3, "compiled execution problem")
})
...
test_that("1D declare with sizes, without c()", {
    ...
    nf1 <- nf()
    expect_equivalent(nf1$run(), array(1:3, dim=c(3)), "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(), 1:3, "compiled execution problem")
})
...
test_that("1D declare with sizes, with c() using a variable", {
    ...
    nf1 <- nf()
    expect_equivalent(nf1$run(3), array(1:3, dim=c(3)), "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(3), 1:3, "compiled execution problem")
})
...
test_that("1D declare with sizes, followed by resize and size inference", {
    ...
    nf1 <- nf()
    m <- matrix(1:9, nrow = 3)
    expect_equivalent(nf1$run(m), m %*% 1:3, "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(m), m %*% 1:3, "compiled execution problem")
})
...
test_that("2D declare without sizes, then resize without c()", {
    ...
    nf1 <- nf()
    expect_equivalent(nf1$run(), matrix(1:8, nrow = 2), "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(), matrix(1:8, nrow = 2), "compiled execution problem")
})
...
test_that("2D declare with sizes, with c() using a variable", {
    ...
    nf1 <- nf()
    expect_equivalent(nf1$run(4), matrix(1:8, nrow = 2), "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(4), matrix(1:8, nrow = 2), "compiled execution problem")
})
...
test_that("2D declare with sizes, followed by resize and size inference", {
    ...
    z <- matrix(1:8, nrow = 2)
    expect_equivalent(nf1$run(4, m), m %*% z, "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(4, m), m %*% z, "compiled execution problem")
})
...
nf1 <- nf()
expect_equivalent(nf1$run(), array(1:24, dim = c(2,4,3)), "R execution problem")
cnf1 <- compileNimble(nf1)
expect_equivalent(cnf1$run(), array(1:24, dim = c(2,4,3)), "compiled execution problem") 
...
test_that("3D declare with sizes, with c() using a variable", {
    ...
    nf1 <- nf()
    expect_equivalent(nf1$run(4), array(1:24, dim = c(2,4,3)), "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(4), array(1:24, dim = c(2,4,3)), "compiled execution problem") 
})
...
test_that("3D declare with sizes, followed by resize and size inferenc", {
    ...
    expect_equivalent(nf1$run(4, m), m %*% z[,,1] , "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(4, m), m %*% z[,,1], "compiled execution problem") 
})
...
test_that("type declarations in arguments, first case", {
    ...
    nf1 <- nf()
    z <- 1:2
    expect_equivalent(nf1$run(z), 1:3, "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(z), 1:3, "compiled execution problem") 
})
...
test_that("type declarations in arguments, third case", {
    ...
    expect_equivalent(nf1$run(z),  matrix(1:8, nrow = 2), "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(z),  matrix(1:8, nrow = 2), "compiled execution problem") 
})
...
test_that("type declarations in arguments, fourth case", {
    ...
    nf1 <- nf()
    expect_equivalent(nf1$run(),  5, "R execution problem")
    cnf1 <- compileNimble(nf1)
    expect_equivalent(cnf1$run(),  5, "compiled execution problem") 
})
...
test_that("numeric cases 1-4", {
    ...
    expect_equal(Rfun(), expected, "case 1")
    expect_equal(Cfun(), expected, "case 2")
    expect_identical(class(Rfun()[1]), 'numeric', "case 3")
    expect_identical(class(Cfun()[1]), 'numeric', "case 4")
})
...
test_that("numeric cases 5-8", {
    ...
    Cfun <- compileNimble(Rfun)
    expect_equal(Rfun(), expected, "case 5")
    expect_equal(Cfun(), expected, "case 6")
    expect_identical(class(Rfun()[1]), 'numeric', "case 7")
    expect_identical(class(Cfun()[1]), 'numeric', "case 8")
})
...
test_that("integer cases 9-12", {
    ...
    Cfun <- compileNimble(Rfun)
    expect_equal(Rfun(), expected, "case 9")
    expect_equal(Cfun(), expected, "case 10")
    expect_identical(class(Rfun()[1]), 'integer', "case 11")
    expect_identical(class(Cfun()[1]), 'integer', "case 12")
})
...
test_that("numeric cases 13-16", {
    ...
    Cfun <- compileNimble(Rfun)
    expect_equal(Rfun(), expected, "case 13")
    expect_equal(Cfun(), expected, "case 14")
    expect_identical(class(Rfun()[1]), 'numeric', "case 15")
    expect_identical(class(Cfun()[1]), 'numeric', "case 16")
})
...
test_that("integer cases 17-20", {
    ...
    Cfun <- compileNimble(Rfun)
    expect_equal(Rfun(), expected, "case 17")
    expect_equal(dim(Cfun()), c(4, 5), "case 18")
    expect_identical(class(Rfun()[1,1]), 'integer', "case 19")
    expect_identical(class(Cfun()[1,1]), 'integer', "case 20")
})
...
test_that("numeric cases 21-24", {
    ...
    Cfun <- compileNimble(Rfun)
    expect_equal(Rfun(), expected, "case 21")
    expect_equal(Cfun(), expected, "case 22")
    expect_identical(class(Rfun()[1]), 'numeric', "case 23")
    expect_identical(class(Cfun()[1]), 'numeric', "case 24")
})
