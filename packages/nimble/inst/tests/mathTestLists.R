...
testsBasicMath = list(
  ...
  list(name = 'modulo of scalars', expr = quote(out <- arg1 %% arg2), inputDim = c(0,0), outputDim = 0, xfail = 'tensorflow.*runs'),  ## FAILS probably due to misbehavior of negative values.
