...
public:
  ...
  // This makes the copied-to object contiguous-memory.  Use mapCopy to copy
  ...
  NimArr<1, T> &operator=(const NimArr<1, bool> &other) {
    return templateCopyOperator<bool>(other);
  }
