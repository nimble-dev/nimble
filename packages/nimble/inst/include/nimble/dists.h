...
// BLAS/LAPACK routines
  ...
  SEXP C_dmnorm_prec_ldet(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
  SEXP C_rmnorm_prec_ldet(SEXP, SEXP, SEXP, SEXP);
...
double dmnorm_prec_ldet(double*, double*, double*, double*, int, int, int, int);
void rmnorm_prec_ldet(double*, double*, double*, double*, int, int);
