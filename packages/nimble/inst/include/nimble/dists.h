...
// BLAS/LAPACK routines
  ...
  */
  ...
  SEXP C_dcar_normal(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
}
...
double dcar_normal(double*, double*, double*, double*, double, int, int, int, int);
void rcar_normal(int, double*, double*, double*, double, int);
