...
double nimArr_dcar_normal(NimArr<1, double> &x, NimArr<1, double> &adj, NimArr<1, double> &weights, NimArr<1, double> &num, double tau, int numIslands, int sumToZero, int give_log) {
  ...
  double ans = dcar_normal(xptr, adjptr, weightsptr, numptr, tau, numIslands, sumToZero, N, L, give_log);
  return(ans);
}


void nimArr_rcar_normal(NimArr<1, double> &ans, NimArr<1, double> &adj, NimArr<1, double> &weights, NimArr<1, double> &num, double tau, int numIslands, int sumToZero) {
  //
