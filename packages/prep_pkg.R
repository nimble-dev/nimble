...
additionalExports <- c("calc_dmnormConjugacyContributions", "calc_dmnormAltParams", "getNodeFunctionIndexedInfo", "singleModelValuesAccess", "getNimbleProject", "nimbleInternalFunctions", "nimbleUserNamespace")
