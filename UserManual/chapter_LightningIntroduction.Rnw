...
\cd{nimbleMCMC} function.  This function can accept the (compiled or uncompiled)
model object as an argument and provides a variety of options for executing and
