...
The `nimbleMacros` package provides an initial set of macros, currently focused on linear modeling and include:
 ...
 - `LINPRED_PRIORS`: specify priors for the coefficients of a linear predictor.
...
And here is a brief example of using the `LINPRED` and `FORLOOP` macros to set up a regression structure.
