...
ensuring that R can find them. For R version 4.0 or greater (Rtools40)
...
For Windows:
  ...
  - If you're using Rtools40, make sure you are using a newer version or RStudio (at least 1.2.5042).
