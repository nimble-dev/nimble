...
For MacOS:
  ...
  - Use on MacOS Catalina (MacOS version 10.15, released in October 2019) may produce an error while installing NIMBLE. Please try running the following in the Terminal to reinstall Xcode/command line tools:
  ```{bash, eval=FALSE}
