...
always return topologically sorted node names.
...
to an existing MCMC configuration object `conf` using:
...
nimbleFunctions that only appear within other nimbleFunctions.  If you
