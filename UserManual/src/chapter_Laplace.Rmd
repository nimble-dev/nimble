...
[Paul, I think we want to mention the use of the skew terms in the asymmetric Gaussian. Can you work that in wherever you think that appropriate, perhaps in some additional text giving a bit more detail on the asymmetric Gaussian?]
...
[This is a normal-normal case so one can marginalize exactly and do inference (MCMC or MLE or otherwise) on the analytically-marginalized model. We could look for a different example, such as the E. cervi example from our trainings.]
