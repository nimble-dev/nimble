...
A convenience function `accumulatorSummary` is also provided, which returns estimates of the posterior mean and standard deviation for each accumulator variable.  See `help(accumulatorSummary)` for the calculations used.
...
accumulatorSummary(Cmcmc)   ## estimated mean and sd
```
...
configureRJ(mcmcConf = RJexampleConf,     
...
configureRJ(mcmcConf = RJexampleConf2,     
            targetNodes = c("beta1", "beta2"),
            priorProb = 0.5,
