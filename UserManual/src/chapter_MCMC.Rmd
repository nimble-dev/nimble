...
toyCode <- nimbleCode({
    ...
    y ~ dnorm(mu, 1)     ## data
    muSq <- mu^2         ## deterministic, non-terminal predictive node
...
- For the most fine-grained control, you can use the `addSampler` method specifying the argument `type="NUTS"` or `type="NUTS_classic"` to add HMC sampler(s) to an MCMC configuration object.
