...
- any 'r' functions.
- any 'p' or 'q' functions (some will be supported in the future).
...
- This will cover how to enable derivatives in user-defined functions and distributions.

## How to test derivatives

- This will cover how to test derivatives.

## Parameter transformations

- This will introduce the parameter transformation system.

## Things to look out for

This will include miscellaneous points unless they are all integrated into other sections.

Some of these include:

- Understanding when model log probs and deterministic node values are updated from tapes.
