...
A `RJ_indicator` sampler is assigned to `z[1]` and `z[2]` in place of the `binary` sampler. Notice that although `fixedValue` is shown in in 

while sampler for `beta[1]`and `beta[2]` have been modified. 
