...
if (length(grep('^-', argv, invert = TRUE))) {
    ...
    blacklist <- c(
        ...
        'benchmarks.R')  # some issue with version conflicts causing tensorflow to fail on Travis with errors such as 'nimble-tensorflow_11_20_18_17_45.so: undefined symbol: TF_DeleteImportGraphDefOptions'
