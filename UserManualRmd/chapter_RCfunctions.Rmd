...
system("cat functionTableMatrixLong.md eigenSvdTableMatrixAsNimList.md > tmp.md")
```
```{r, child = 'tmp.md'}
```
```{r echo=FALSE, include=FALSE}
...
(determined during execution).  If `x` is used subsequently, it can
