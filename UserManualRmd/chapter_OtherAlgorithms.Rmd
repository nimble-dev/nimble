...
to `addSampler` with `type = "RW_PF"` or `type =
  "RW_PF_block"`, a syntax similar to the other MCMC samplers listed
...
```
  ...
  either `latentNodes = "x"` or `latentNodes = c("x[1]",
    "x[2]")` will treat `x[1]` and `x[2]` as latent nodes if
